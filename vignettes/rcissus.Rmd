...
trnBas$basisMat = trnBas$basisMat[ 1:( ncol(trnBas$basisMat) - 2 ),  ] # select basis vectors
...
trn = rcTrain( trnMat1$y, traindf, mdlMethod = mth, epochs = 10 )
...
# if h2o works on your machine, use deep learning
trn = rcTrain( trnMat1$y, traindf, classification = TRUE, mdlMethod = mth, epochs = 10 )
